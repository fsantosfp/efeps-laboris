...
- [ ] **Tarefa 1.1: Script de Migração do Banco de Dados**
  - **Ações:**
...
- [ ] **Tarefa 2.1: Atualização da Entidade Job**
  - **Ações:**
...
- [ ] **Tarefa 2.2: Atualização do CreateJobRequestDto e Validações**
  - **Ações:**
    ...
    - Adicionar `responsibleName`, `responsiblePhone` com `@NotBlank` e `responsibleEmail` com `@Email` (opcional).
  - **Critério de Aceitação:** Os testes do backend validam as restrições obrigatórias.

- [ ] **Tarefa 2.3: Atualização do UpdateJobRequestDto**
  - **Ações:**
...
- [ ] **Tarefa 2.4: Atualização do JobResponseDto**
  - **Ações:**
...
- [ ] **Tarefa 2.5: Atualização das Regras de Serviço no JobService**
  - **Ações:**
...
- [ ] **Tarefa 2.6: Testes Automatizados do Backend**
  - **Ações:**
...
- [ ] **Tarefa 3.1: Obtenção de Coordenadas no PlacesAutocompleteInput**
  - **Ações:**
...
- [ ] **Tarefa 3.2: Formulário de Criação de Trabalhos**
  - **Ações:**
...
- [ ] **Tarefa 3.3: Exibição dos Detalhes Completos**
  - **Ações:**
...
- [ ] **Tarefa 3.4: Implementação de Edição no Frontend**
  - **Ações:**
...
- [ ] **Tarefa 3.5: Confirmação Customizada de Deleção**
  - **Ações:**
